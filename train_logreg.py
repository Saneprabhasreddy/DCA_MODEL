...
Run:
python train_logreg.py --dataset_path data/fedex_dca_synthetic_dataset/cases.csv --artifacts_dir artifacts --threshold 0.5
"""
...
def build_preprocess() -> ColumnTransformer:
    # For Logistic Regression, scaling numeric features helps a lot.
    cat_pipe = Pipeline(
        steps=[
