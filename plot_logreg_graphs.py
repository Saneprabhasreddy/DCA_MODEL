...
def plot_threshold_curve(y_true, y_prob, out_path):
    ...
    plt.title("Threshold vs Precision/Recall/F1 (Logistic Regression)")
...
def main():
    ...
    ap.add_argument("--pred_csv", default="artifacts/test_predictions_logreg.csv")
    ap.add_argument("--out_dir", default="artifacts/plots/logreg")
