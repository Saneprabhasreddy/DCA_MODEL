...
TITLE_PREFIX = "HistGradientBoosting"
...
def main():
    ...
    ap.add_argument("--pred_csv", default="artifacts/test_actual_vs_predicted.csv")
    ap.add_argument("--out_dir", default="artifacts/plots/hgb")
    ...
    # compute predicted using given threshold (ignore saved predicted column)
    ...
    print("✅ Saved HGB plots in:", args.out_dir)
